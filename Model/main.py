...
def run_scenarios():
    ...
    all_combos = list_all_combos([
            ...
            ["min", "med", "max"],                                              #   climate_choice
            ["min", "med"],                                             #   eco_min_separation_choice
            ["med"],                                            #   eco_min_duration_choice
            ["min", "med"],                                             #   eco_ctf_choice
            [0.5, 1.],                                                          #   AWD_surface_choice
            [0.5, 1.],                                                          #   AWD_gw_choice
            [0.5, 1., 1.5],                                                             #   crop_price_choice
            ["Roberts", "Rogers"],
            ["Roberts", "Rogers"],
            ["Roberts", "Rogers"],
            ["Index", "F1"]
    ...
    default_combos = [
        ["Default", "med", "med", "med", "med", "med", "med", "min", 0.75, 0.75, 1., 'Roberts', 'Roberts', 'Roberts', 'Index'], #base case  
        ["Default", "min", "min", "min", "min", "med", "med", "min", 0.5, 0.5, 0.5, 'Roberts', 'Roberts', 'Roberts', 'Index'],  #min case
        # ["Default", "min", "min", "max", "min", "med", "med", "med", 0.5, 0.5, 0.5, 'Roberts', 'Roberts', 'Roberts', 'Index'],    #min case
        ["Default", "max", "max", "max", "max", "med", "med", "min", 1., 1., 1., 'Roberts', 'Roberts', 'Roberts', 'Index'], #max case
        # ["Default", "med", "med", "med", "med", "med", "med", "med", 1., 1., 1., 'Roberts', 'Roberts', 'Roberts', 'Index'],   #base case  
    ]
